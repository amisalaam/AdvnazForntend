...
<footer className="bg-advanzBlue ">
    ...
    <div className="px-4 py-6 bg-gray-100  md:flex md:items-center md:justify-between rounded-xl">
        <span className="text-sm text-black sm:text-center">© 2023 <a href="https://flowbite.com/">Advanz™</a>. All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
            <a href="#" className="text-balck hover:text-white ">
