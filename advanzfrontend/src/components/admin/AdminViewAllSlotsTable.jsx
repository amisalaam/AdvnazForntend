...
const ViewAllSlots = ({ user }) => {
  ...
  .filter((user) => {
    ...
    const startTimeMatches = startTime === "" || user.start_time?.localeCompare(startTime) >= 0;
    const endTimeMatches = endTime === "" || user.end_time?.localeCompare(endTime) <= 0;
                  ...
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th scope="col" className="px-6 py-3 text-lg text-gray-900 hidden md:table-cell text-center">
                        Time
                      </th><th scope="col" className="px-6 py-3 text-lg text-gray-900 hidden md:table-cell text-center">
                        Date
                      </th>
