  ...
  return (
    <div>
      <button
        ...
        type="button"
        className="inline-flex items-center p-2 mt-2  text-sm text-white bg-advanzBlue rounded sm:hidden hover:bg-advanzRed focus:outline-none focus:ring-2 focus:ring-gray-200"
      ...
      <aside
        id="default-sidebar"
        className={`left-0 z-40 w-[268px] h-[40rem] transition-transform rounded ${
